...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://lumascale.in/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://lumascale.in/logo.png",
          image: "https://lumascale.in/og-image.png",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          potentialAction: {
            "@type": "SearchAction",
            target: "https://lumascale.in/?q={search_term_string}",
